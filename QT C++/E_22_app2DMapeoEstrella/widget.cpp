...
void Widget::asignarFigura()
{
    ...
    */
    ...
    Fig[0][0] = 0; Fig[0][1] = 7; Fig[0][2] = 1;
    Fig[1][0] = 10.75; Fig[1][1] = 28; Fig[1][2] = 1;
    Fig[2][0] = 21.5; Fig[2][1] = 7; Fig[2][2] = 1;


    Fig2[0][0] = 0; Fig2[0][1] = 21; Fig2[0][2] = 1;
    Fig2[1][0] = 10.75; Fig2[1][1] = 0; Fig2[1][2] = 1;
    Fig2[2][0] = 21.5; Fig2[2][1] = 21; Fig2[2][2] = 1;
    ...
    points2[0].setX(Fig2[0][0]);
    points2[0].setY(Fig2[0][1]);

    points2[1].setX(Fig2[1][0]);
    points2[1].setY(Fig2[1][1]);

    points2[2].setX(Fig2[2][0]);
    points2[2].setY(Fig2[2][1]);

    points2[3].setX(Fig2[3][0]);
    points2[3].setY(Fig2[3][1]);
...
void Widget::dibujarFiguraMapeada()
{
    ...
    //int L = centroX;
    int L = 0; //SE DEBE CONSIDERAR XPVMIN
    int M = centroY;
