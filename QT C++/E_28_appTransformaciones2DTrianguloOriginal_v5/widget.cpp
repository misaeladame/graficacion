...
void Widget::asignarFigura()
{
    ...
    */
    ...
    /*
    Fig[0][0] = 30; Fig[0][1] = 10; Fig[0][2] = 1;
    Fig[1][0] = 50; Fig[1][1] = 10; Fig[1][2] = 1;
    Fig[2][0] = 40; Fig[2][1] = 30; Fig[2][2] = 1;

    Fig2[0][0] = 30; Fig2[0][1] = 10; Fig2[0][2] = 1;
    Fig2[1][0] = 50; Fig2[1][1] = 10; Fig2[1][2] = 1;
    Fig2[2][0] = 40; Fig2[2][1] = 30; Fig2[2][2] = 1;
    */

    Fig[0][0] = 50; Fig[0][1] = 30; Fig[0][2] = 1;
    Fig[1][0] = 70; Fig[1][1] = 30; Fig[1][2] = 1;
    Fig[2][0] = 60; Fig[2][1] = 50; Fig[2][2] = 1;

    Fig2[0][0] = 50; Fig2[0][1] = 30; Fig2[0][2] = 1;
    Fig2[1][0] = 70; Fig2[1][1] = 30; Fig2[1][2] = 1;
    Fig2[2][0] = 60; Fig2[2][1] = 50; Fig2[2][2] = 1;
    ...
    */
    ...
    // PUNTO DE INICIO
    Fig[3][0] = 50; Fig[3][1] = 30; Fig[3][2] = 1;
    Fig2[3][0] = 50; Fig2[3][1] = 30; Fig2[3][2] = 1;
...
void Widget::dibujarFiguraMapeada()
{
    ...
    canvas->drawLine(this->size().width()/2, altura/2, this->size().width(), 0);
...
void Widget::rotarSentidoHorario(double angulo_grados)
{
    Matrix fig, id, fres; // OBJETOS ESTATICOS
    fig.Inicializa(4, 3);
    // figura resultante
    ...
    // APLICAR LA ROTACION
    fres.rotacionSentidoHorario(fig, id, angulo_grados);
