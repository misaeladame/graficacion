...
Matrix &Matrix::rotacionSentidoHorario(Matrix f, Matrix id, double grados)
{
    double radianes = grados *  M_PI / 180;
    id.SET(0, 0, cos( radianes ));
    id.SET(0, 1, -sin( radianes ));
...
Matrix &Matrix::rotacionPuntoPivote(Matrix f, Matrix id, double grados, int xr, int yr)
{
    double radianes = grados * M_PI / 180;
    id.SET(0, 0, cos( radianes ));
    id.SET(0, 1, sin( radianes ));
    id.SET(1, 0, -sin( radianes ));
    id.SET(1, 1, cos ( radianes ));
    //id.SET(2, 0, -xr * ( cos(radianes) - 1 ) + yr * sin(radianes));
   // id.SET(2, 1, -xr * sin(radianes) - yr * ( cos(radianes) - 1 ));

    id.SET(2, 0, xr * ( 1 - cos(radianes) ) + yr * sin(radianes));
    id.SET(2, 1, yr * ( 1 - cos(radianes) ) - xr * sin(radianes));
    id.SET(2, 2, 1);
...
Matrix &Matrix::reflexionEjeCoordenado(Matrix f, Matrix id)
{
    id.SET(0, 0, -1);
    id.SET(1, 1, -1);
    id.SET(2, 2, 1);
...
Matrix &Matrix::reflexionRectaYIgualX(Matrix f, Matrix id)
{
    id.SET(1, 0, 1);
    id.SET(0, 1, 1);
    id.SET(2, 2, 1);
...
Matrix &Matrix::reflexionRectaYIgualMenosX(Matrix f, Matrix id)
{
    id.SET(1, 0, -1);
    id.SET(0, 1, -1);
    id.SET(2, 2, 1);
