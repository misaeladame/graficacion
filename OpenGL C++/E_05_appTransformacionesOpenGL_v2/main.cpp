...
void dibuja() {
	...
	glPushMatrix();
		...
		glBegin(GL_POLYGON);
			glColor3f(0.3, 1, 0);glVertex3f(100, 100, 0);
			glColor3f(1, 0.3, 0.6);glVertex3f(100, -100, 0);
			glColor3f(0, 0.5, 1);glVertex3f(-100, -100, 0);
			glColor3f(0.6, 0.2, 1);glVertex3f(-100, 100, 0);
		glEnd();
	glPopMatrix();
	glutSwapBuffers();
}
